...
table_df["Absolute Change"] = abs(table_df["2022"] - table_df["2000"])

# Calculate relative change as the absolute change divided by the 2000 emissions, then multiplied by 100
table_df["Relative Change"] = 100 * table_df["Absolute Change"] / table_df["2000"] 
...
emissions_long_1990_2022 = emissions_long.query("year >= 1990 & year <= 2021")

emissions_long_1990_2022

# Query for 5 countries (adjust these to any countries you like)
emissions_long_subset = emissions_long_1990_2022.query("country == 'UAE' | country == 'Armenia' | country == 'Equatorial Guinea' | country == 'Kazakhstan' | country == 'Tunisia'")
